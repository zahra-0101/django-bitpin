...
SECRET_KEY = 'django-insecure-aet1euxvroha4ow3w89r!b=loy9yh4(-t7(%=cid0o-d$z^kdq'
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    os.environ.get('DJANGO_ALLOWED_HOSTS', 'app.bitpin.net'),
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'bitpin'),
